...
(2, 224, 'B-2', 'tourism, vacation, pleasure visitor');
...
INSERT INTO `CustAppInfo` (`CustAppInfoId`, `CustProfileInfoId`, `CountryListId`, `CountryVisaTypeListId`, `CustAppNumber`, `Activated`, `Completed`, `Submitted`) VALUES
(6, 8, 224, 2, 'APP008224B-2', '1', '0', '0'),
(7, 8, 224, 2, 'APP008224B-2', '1', '0', '0'),
(8, 8, 224, 2, 'APP008224B-2', '1', '0', '0');
...
(7, 6, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'male', 'married', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(8, 8, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'male', 'married', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
(21, 'bwells', 'Brooke', 'Wells', 'bwells@gmail.com', 'bw77', '', '0'),
...
--
ALTER TABLE `CountryVisaTypeList`
  MODIFY `CountryVisaTypeListId` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `CustAppInfo`
--
ALTER TABLE `CustAppInfo`
  MODIFY `CustAppInfoId` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=9;
--
...
--
ALTER TABLE `CustPersonalInfo`
  MODIFY `CustPersonalInfoId` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=9;
--
...
--
ALTER TABLE `CustProfileInfo`
  MODIFY `CustProfileInfoId` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=28;
--
