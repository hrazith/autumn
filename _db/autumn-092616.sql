...
--
-- Host: localhost:3306
-- Generation Time: Sep 27, 2016 at 01:13 AM
...
(43, 8, 224, 2, 'APP008224B-2', '1', '0', '0', '2016-09-14 02:46:40', '2016-09-26 19:03:03'),
...
(3, 43, 'Harun', 'Razith', '', 'no', '', '', '', 'male', 'single', '12/10/1977', 'Bangalore', 'Karnataka', 'India', 'Spain', '017980345', '086-98-4356', '112345773', '571, 56 St', 'West New York'),
(4, 47, 'Brooke', 'Wells ', '', 'no', '', '', '', 'female', 'divorced', '', '', '', '', '', '', '', '', '', ''),
(23, 87, 'Jennifer', 'Smith', '', 'no', '', '', '', 'female', 'single', '13/12/1984', 'Rome', 'Eataly', 'Italy', '', '', '', '', '12 Jacobs Sink Hole', 'Arligton '),
(24, 88, 'Jack', 'Abbot', '', 'no', '', '', '', 'male', 'single', 'Jan 2, 1999', 'Rome', 'Rome State', 'Choose...', '', 'JA4532', 'N/A', '7723451', '12 Tiramisu way', 'Rome');
...
--
ALTER TABLE `custappinfo`
  MODIFY `CustAppInfoId` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=89;
--
...
--
ALTER TABLE `custlocalinfo`
  MODIFY `CustLocalInfoId` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=6;
--
...
--
ALTER TABLE `custpersonalinfo1`
  MODIFY `CustPersonalInfoId` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=25;
--
-- AUTO_INCREMENT for table `custpersonalinfo2`
--
ALTER TABLE `custpersonalinfo2`
  MODIFY `CustPersonalInfoId` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=7;
--
...
--
ALTER TABLE `custpreparerappinfo`
  MODIFY `CustPrepareAppInfoId` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `custprofileinfo`
--
ALTER TABLE `custprofileinfo`
  MODIFY `CustProfileInfoId` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=30;
--
...
--
ALTER TABLE `custworkeducationtraininginfo`
  MODIFY `CustWorkEducationTrainingInfoId` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=6;
--
