...
--
-- Host: localhost:3306
-- Generation Time: Oct 14, 2016 at 03:32 AM
...
(104, 8, 224, 2, 'APP008224B-2', '1', '0', '0', '2016-10-14 01:07:22', NULL);
...
(3, 43, 'Harun', 'Razith', '', 'no', '', '', '', 'male', 'married', '', '', '', 'Choose...', '', '', '', '', '', ''),
(4, 47, 'Brooke', 'Wells ', '', 'no', '', '', '', 'female', 'divorced', '', 'Barcelona', '', '', '', '', '', '', '', ''),
(23, 87, 'Jenn', 'Smith', 'n/a', 'no', '', '', '', '', '', '12/10/2000', 'Barcelona', 'Barx', 'Spanish', '', '', '', '', '', ''),
(26, 103, 'Suraya', 'Prakash', 'BSSP', 'no', '', '', '', 'male', 'married', '10/03/1978', 'Bangalore', 'Karnataka', 'India', 'Iceland', 'IND231478ST1', '', '', '', ''),
(27, 104, '', '', '', '', '', '', '', '', '', '', '', '', 'Choose...', '', '', '', '', '', '');
...
--
ALTER TABLE `custappinfo`
  MODIFY `CustAppInfoId` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=105;
--
...
--
ALTER TABLE `custlocalinfo`
  MODIFY `CustLocalInfoId` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=12;
--
...
--
ALTER TABLE `custpersonalinfo1`
  MODIFY `CustPersonalInfoId` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=28;
--
...
--
ALTER TABLE `custpersonalinfo3`
  MODIFY `CustPersonalInfoId` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `custpreparerappinfo`
--
ALTER TABLE `custpreparerappinfo`
  MODIFY `CustPrepareAppInfoId` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=11;
--
...
--
ALTER TABLE `custtravelinfo1`
  MODIFY `CustTravelInfoId` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `custtravelinfo2`
--
ALTER TABLE `custtravelinfo2`
  MODIFY `CustTravelInfoId` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `custuscontactinfo`
--
ALTER TABLE `custuscontactinfo`
  MODIFY `CustUSContactInfoId` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=8;
--
-- AUTO_INCREMENT for table `custworkeducationtraininginfo`
--
ALTER TABLE `custworkeducationtraininginfo`
  MODIFY `CustWorkEducationTrainingInfoId` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=12;
--
